...
app.layout = html.Div(
    [   html.Div(className='container-fluid', children=[html.H2('PyAllEars - Live Twitter Sentiment Analysis - SIIT,TU ', style={'color':"#CECECE",'textAlign': 'center'}),
                                  			html.H6('This was created as a project for Social Network Eavesdropping. ', style={'color':"#660000",'textAlign': 'center'}),
             						html.H6('Instruction: No need to press Enter key as the search is instant. If word does not show up refresh this page or delete the search content and wait for 10 seconds before trying again. Inspired by Sentdex.', style={'color':"#660000",'textAlign': 'center'}),
                                                        html.H5('Search any word(s)', style={'color':app_colors['text'],'textAlign': 'center'}),
                                                  dcc.Input(id='sentiment_term', value='twitter', type='text', style={'color':'#1AD1FF'}),
                                                  ],
